jQuery(document).ready(function() {
    ...
    jQuery(function() {
        ...
        jQuery('a.set_theme').click(function() {
			...
			setTimeout(function () { 
			jQuery("link[title='style']").attr("href","/DDoctor/css/themes/" + theme_name + "/ui.css");
			}, 500);
		...
		if (theme == 'black_rose') {
	        jQuery("link[title='style']").attr("href","/DDoctor/css/themes/black_rose/ui.css");
	        
	    };

		if (theme == 'gray_standard') {
	        jQuery("link[title='style']").attr("href","/DDoctor/css/themes/gray_standard/ui.css");
	    };

		if (theme == 'gray_lightness') {
	        jQuery("link[title='style']").attr("href","/DDoctor/css/themes/gray_lightness/ui.css");
	    };
	    
		if (theme == 'blueberry') {
	        jQuery("link[title='style']").attr("href","/DDoctor/css/themes/blueberry/ui.css");
	    };
	    
		if (theme == 'apple_pie') {
	        jQuery("link[title='style']").attr("href","/DDoctor/css/themes/apple_pie/ui.css");
	    };
