...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, :endereco => { :cep => @endereco.cep, :cidade => @endereco.cidade, :complemento => @endereco.complemento, :estado => @endereco.estado, :numero => @endereco.numero, :rua => @endereco.rua }
    end
  ...
  test "should update endereco" do
    put :update, :id => @endereco, :endereco => { :cep => @endereco.cep, :cidade => @endereco.cidade, :complemento => @endereco.complemento, :estado => @endereco.estado, :numero => @endereco.numero, :rua => @endereco.rua }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
